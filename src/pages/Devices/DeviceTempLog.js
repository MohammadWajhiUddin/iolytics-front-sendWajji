...
const DeviceTempLog = () => {
  ...
  const fetchSchedules = async () => {
    try {
      const response = await fetch(
        "https://tempin.qastco.co.uk:3231/api/schedule/selecttemplog",
        {
          method: "POST",
          headers: {
  ...
  const handleSubmitSchedules = async () => {
    try {
      ...
      const response = await fetch("https://tempin.qastco.co.uk:3231/api/schedule/inserttemplogsch", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="container mt-2">
      ...
      <h1 style={{textAlign:'center',marginBottom:30}}>{device_name} Device Temp Log Schedules</h1>
