...
const SparklineDownAlert = data => {
  ...
  const extractAlerts = data => {
    ...
    data.data.forEach(item => {
        const alertValue = parseInt(item.totalDownAlert);
      totalAlerts.push(parseInt(item.totalDownAlert))
      ...
      <div className="wid-peity mb-4">
        <div className="row">
          <div className="col-md-3">
            <div>
              <p className="text-muted"> Down Alerts</p>
...
export default SparklineDownAlert
