...
const SparklineUpAlert = data => {
  ...
  const extractAlerts = data => {
    ...
    data.data.forEach(item => {
        const alertValue = parseInt(item.totalUpAlert);
      totalAlerts.push(parseInt(item.totalUpAlert))
      ...
      <div className="wid-peity mb-4">
        <div className="row">
          <div className="col-md-3">
            <div>
              <p className="text-muted">Up Alerts</p>
...
export default SparklineUpAlert
